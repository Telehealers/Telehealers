                        ...
                        <tbody>
                           <?php
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="">
                                    <a  class="btn btn-xs btn-danger" href="<?php echo base_url();?>admin/Users_controller/delete_user/<?php echo html_escape($value->log_id) ;?>" onclick="return confirm('Are you want to delete?');">
