                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="<?php echo base_url();?>admin/email/Email/delete_schedule/<?php echo html_escape($value->email_ss_id) ;?>" onclick="return confirm('Are you want to delete?');" class="btn btn-xs btn-danger">
