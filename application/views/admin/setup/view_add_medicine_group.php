                        ...
                        <div  class="panel panel-default panel-form">
                            ...
                            <div class="panel-heading ">
                                <div class="panel-title" >
                                    <h4><?php echo display('add_group');?></h4>
                                </div>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="<?php echo base_url();?>admin/Setup_controller/delete_group/<?php echo html_escape($value->med_group_id);?>" onclick="return confirm('Are you want to delelte?');" class="btn btn-xs btn-danger">
