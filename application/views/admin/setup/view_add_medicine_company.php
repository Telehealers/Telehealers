            ...
            <div  class="panel panel-default panel-form">
                ...
                <div class="panel-heading ">
                    <div class="panel-title" >
                        <h4><?php echo display('add_company');?></h4>
                    </div>
                </div>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="<?php echo base_url();?>admin/Setup_controller/delete_medicine_company/<?php echo html_escape($value->company_id);?>" onclick="return confirm('Are you want to delelte?');" class="btn btn-xs btn-danger">
