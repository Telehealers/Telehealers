            ...
            <div class="col-md-12">
                ...
                <div class="panel-heading ">
                    <div class="panel-title" >
                        <h4><?php echo display('add_advice');?></h4>
                    </div>
                </div>
                        ...
                        ?>
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="col-md-2 control-label"><span class="text-danger">*</span><?php echo display('advice');?> :</label>
                                        <div class="col-md-9">
                    ...
                    <div class="panel-body">
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo html_escape($value->advice);?></td>
                                    <td class="text-right">
                                        <a href="<?php echo base_url();?>admin/Setup_controller/delete_advice/<?php echo html_escape($value->advice_id);?>" onclick="return confirm('Are you want to delelte?');" class="btn btn-xs btn-danger">
