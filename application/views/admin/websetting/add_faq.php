                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        <?php 
                            ...
                            echo form_open_multipart('admin/faq/save_post', $attributes);                
                         ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <textarea name="details" id="" value="<?php echo set_value('details'); ?>"
                                         class="form-control" rows="7" maxlength="1600" required></textarea>
                                         <span class="text-warning">The element with a maximum length of 1600 characters</span>
                                    </div>
                                </div>
