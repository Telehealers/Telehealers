                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        <?php 
                            ...
                            echo form_open_multipart('admin/theraphists/save_edit_post', $attributes);                
                         ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo display('details');?> : </label>
                                        <div class="col-md-7">
                                            ...
                                            class="form-control" rows="6" maxlength="" required> <?php echo htmlspecialchars_decode($post_info->details); ?></textarea>
