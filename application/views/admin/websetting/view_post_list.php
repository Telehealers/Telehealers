            ...
            <div  class="panel panel-default">
                 ...
                 <div class="panel-heading">
                    <div class="panel-title">
                        <h4><?php echo display('post_list');?></h4>
                    </div>
                </div>
                        ...
                        <tbody>
                           <?php
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td width="100">
                                    <a  class="btn btn-xs btn-info" href="<?php echo base_url();?>admin/Blog_controller/edit_post/<?php echo html_escape($value->id);?>">
                                    <i class="fa fa-edit"></i> </a>
                                    <a  class="btn btn-xs btn-danger" href="<?php echo base_url();?>admin/Blog_controller/delete_post/<?php echo html_escape($value->id) ;?>" onclick="return confirm('Are you want to delelte?');">
