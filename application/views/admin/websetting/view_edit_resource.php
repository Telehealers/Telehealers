...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('edit_resource');?></h1>
            <small><?php echo display('edit_resource');?></small>
            <ol class="breadcrumb">
            ...
            <div  class="panel panel-default panel-form">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4><?php echo display('edit_resource');?></h4>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        <?php 
                            ...
                            echo form_open_multipart('admin/Resource_controller/save_edit_post', $attributes);                
                         ?>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                    <a target="_blank" href="<?php echo html_escape($post_info->picture);?>">Document</a><br>
                                        <input style="margin-top:30px;" type="file" name="picture">    
                                         <span></span>   
                                    </div>
                                </div>
