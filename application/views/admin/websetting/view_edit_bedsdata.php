...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('edit_bedsdata');?></h1>
            <small><?php echo display('edit_bedsdata');?></small>
            <ol class="breadcrumb">
            ...
            <div  class="panel panel-default panel-form">
                ...
                <div class="panel-heading">
                    <div class="panel-title">
                        <h4><?php echo display('edit_bedsdata');?></h4>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        <?php 
                            ...
                            echo form_open_multipart('admin/Bedsdata_controller/save_edit_post', $attributes);                
                         ?>
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label"><?php echo display('details');?> : </label>
                                        <div class="col-md-7">
										<input type="text" name="details" class="form-control" value="<?php echo html_escape($post_info->url); ?>" placeholder="Url" required> 
                                        </div>
                                </div>
