...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="header-title">
            <h1>Edit Precautions</h1>
            <small>Edit Precautions</small>
            <ol class="breadcrumb">
                ...
                <div class="panel-body">
                    <div class="portlet-body form">
                        <?php 
                            ...
                            echo form_open_multipart('admin/Precautions_controller/save_edit_post', $attributes);                
                         ?>
