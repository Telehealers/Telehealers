                    ...
                    ?>
                            ...
                            <div class="form-body">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                       <select class="form-control" name="teamplate_id" required="1" >
                                            ...
                                            <option value="<?php echo html_escape($value1->teamplate_id)?>"><?php echo htmlspecialchars_decode($value1->teamplate_name);?></option>
                                            <?php }?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <select name="day">
                                          <option value="0">--<?php echo display('day');?>--</option>
                                          <?php for($i=1;$i<=30; $i++)
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <a href="<?php echo base_url();?>admin/Sms_setup_controller/delete_schedule/<?php echo html_escape($value->ss_id) ;?>" onclick="return confirm('Are you want to delelte?');" class="btn btn-xs btn-danger">
