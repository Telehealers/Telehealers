                                                    ...
                                                    <div class="col-md-12">
                                                        <select class="form-control" name="venue_id" required>
                                                            ...
                                                            <?php foreach($venue as $v_enue){
                                                                echo '<option value="'. html_escape($v_enue->venue_id).'" '.($this->session->userdata('v_id')==$v_enue->venue_id?'selected':'').'>'.html_escape($v_enue->venue_name).'</option>';
                                                            } ?>
                                                        </select>  
...
<?php $this->load->view('admin/script/create_new_prescription.php');?>