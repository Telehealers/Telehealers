...
*/
 public function getMedicineList()
 {
	...
	$this->db->select("medecine_info.*,
         ...
         $this->db->join('medicine_company_info', 'medicine_company_info.company_id= medecine_info.med_company_id','left'); 
         $this->db->join('medicine_group_tbl', 'medicine_group_tbl.med_group_id= medecine_info.med_group_id','left'); 
	     $query = $this->db->get();
