...
class Represcription extends CI_model {
    ...
    public function re_test_data($prescription_id){
         ...
         ->join('test_name_tbl', 'test_name_tbl.test_id = test_assign_for_patine.test_id','left')
    ...
    public function re_advice_data($prescription_id){     
	        // advice query
	         ...
	         ->join('doctor_advice', 'doctor_advice.advice_id = advice_prescriptiion.advice_id','left')
