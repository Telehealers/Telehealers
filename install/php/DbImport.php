...
class DbImport 
{
    ...
    private $table_name = 'log_info';      //Login Table Name
    private $table_fields = array('email', 'password','user_type','active_status'); // Table Field Names
    ...
    */
    ...
    function insert_login($data = [])
    {
        ...
        $sql = "INSERT INTO `doctor_tbl` (log_id,doctor_name) VALUES ( $insert_id, 'Demo name')";
        $mysqli->query($sql);
