...
class BasicWalkerNavMenu extends Walker_Nav_Menu
{
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) 
    {
        ...
        $attributes .= (is_object($args) && $args->has_children) ? ' class="nav-link dropdown-toggle dropdown-item" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"' : ' class="nav-link dropdown-item"';
